...
public class Controlador extends WindowAdapter implements ActionListener {
    ...
    private String usuarioActual = "Invitado";
    ...
    public Controlador(Vista vista, Modelo modelo) {
        ...
        this.vista.btnCerrarExitoPDF.addActionListener(this);
        
        this.vista.ventana.addWindowListener(this);
        this.vista.dlgFormMonitor.addWindowListener(this);
        this.vista.dlgFormAventurero.addWindowListener(this);
        this.vista.dlgFormActividad.addWindowListener(this);
        this.vista.dlgFormPart.addWindowListener(this);
        this.vista.dlgSeleccion.addWindowListener(this);
        this.vista.dlgConsulta.addWindowListener(this);
        this.vista.dlgMensaje.addWindowListener(this);
        this.vista.dlgExitoPDF.addWindowListener(this);
    }
    ...
    public void windowClosing(WindowEvent e) {
        ...
        if (src == vista.dlgFormMonitor) vista.dlgFormMonitor.setVisible(false);
        else if (src == vista.dlgFormAventurero) vista.dlgFormAventurero.setVisible(false);
        else if (src == vista.dlgFormActividad) vista.dlgFormActividad.setVisible(false);
        else if (src == vista.dlgFormPart) vista.dlgFormPart.setVisible(false);
        else if (src == vista.dlgSeleccion) vista.dlgSeleccion.setVisible(false);
        else if (src == vista.dlgConsulta) vista.dlgConsulta.setVisible(false);
        else if (src == vista.dlgMensaje) vista.dlgMensaje.setVisible(false);
        else if (src == vista.dlgExitoPDF) vista.dlgExitoPDF.setVisible(false);
        else System.exit(0);
    }
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (src == vista.btnEntrar) {
            ...
            String[] lineas = vista.lstTablaConsulta.getItems();
            String ruta = modelo.exportToPDF(lineas);
            if (ruta != null) {
                vista.txtRutaPDF.setText(ruta);
                vista.dlgExitoPDF.setLocationRelativeTo(vista.ventana);
                vista.dlgExitoPDF.setVisible(true);
            }
        }
        else if (src == vista.btnCerrarExitoPDF) {
            vista.dlgExitoPDF.setVisible(false);
        }
            ...
            if (seccionActiva.equals("Monitores")) {
                ...
                vista.txtMonFechaIngreso.setText(""); // LIMPIAR FECHA
                ...
                vista.btnGuardarActividad.setLabel("Guardar Actividad");
                vista.txtActNombre.setText(""); vista.txtActPrecio.setText(""); vista.txtActDuration.setText("");
                vista.txtActFechaAct.setText(""); // LIMPIAR FECHA
                ...
                vista.txtPartFechaInsc.setText("");
            ...
            if (vista.choSeleccionGeneral.getSelectedIndex() > 0) {
                ...
                if (seccionActiva.equals("Monitores")) {
                    ...
                    if(datos != null) {
                        ...
                        vista.txtMonFechaIngreso.setText(datos[4]); // CARGAR FECHA EURO
                    ...
                    if(datos != null) {
                        ...
                        vista.txtAveFechaNac.setText(datos[4]); // CARGAR FECHA EURO
                    ...
                    if(datos != null) {
                        ...
                        vista.txtActFechaAct.setText(datos[4]); // CARGAR FECHA EURO
                        vista.choMonitoresActDlg.removeAll(); vista.choMonitoresActDlg.add("Seleccionar Monitor...");
                        for (String m : modelo.obtenerMonitores()) vista.choMonitoresActDlg.add(m);
                    ...
                    String[] datosPart = modelo.buscarHoraYFechaParticipacion(idFkEditando1, idFkEditando2).split("\\|");
                    vista.txtHoraDlg.setText(datosPart[0]);
                    vista.txtPartFechaInsc.setText(datosPart.length > 1 ? datosPart[1] : ""); // CARGAR FECHA EURO
            ...
            try {
                ...
                String f = vista.txtMonFechaIngreso.getText().trim(); // EXTRAER FECHA
                
                boolean exito = modoEdicion ? modelo.modificarMonitor(idFkEditando1, nom, ape, em, sal, f) : modelo.altaMonitor(nom, ape, em, sal, f);
                if (exito) { 
                ...
                else { vista.mostrarAviso("Error: Formato de fecha dd/MM/yyyy incorrecto."); }
            ...
            String f = vista.txtAveFechaNac.getText().trim(); // EXTRAER FECHA
            
            boolean exito = modoEdicion ? modelo.modificarAventurero(idFkEditando1, nom, ape, em, tel, f) : modelo.altaAventurero(nom, ape, em, tel, f);
            if (exito) { 
            ...
            try {
                ...
                String f = vista.txtActFechaAct.getText().trim(); // EXTRAER FECHA
                
                boolean exito = modoEdicion ? modelo.modificarActividad(idFkEditando1, nom, pre, dur, idMon, f) : modelo.altaActividad(nom, pre, dur, idMon, f);
                if (exito) { 
            ...
            if (vista.choAventurerosDlg.getSelectedIndex() > 0 && vista.choActividadesDlg.getSelectedIndex() > 0) {
                ...
                String f = vista.txtPartFechaInsc.getText().trim();
                
                boolean exito = modoEdicion ? modelo.modificarParticipacion(idFkEditando1, idFkEditando2, idAveNuevo, idActNuevo, h, f) : modelo.altaParticipacion(idAveNuevo, idActNuevo, h, f);
                if (exito) { 
